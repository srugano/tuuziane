...
class BaseViewMixin(APIView):
    ...
    def _get_exception_status_code(self, error):
        ...
        elif isinstance(error, (ValidationError, DjangoValidationError)):
            return status.HTTP_400_BAD_REQUEST, "VALIDATION_ERROR"

        # Not found errors (4xx)
        elif isinstance(error, (NotFound, ObjectDoesNotExist)):
...
class BaseViewSetMixin(
    ...
    search_fields = []  # To be set in subclasses
    ordering_fields = []  # To be set in subclasses
